<template>
    <breeze-authenticated-layout>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-gray-800 border-b border-gray-200">
                        <Toolbar class="p-mb-4">
                            <template #left>
                                <Button :disabled="multipleGuillotine" label="Guillotine" icon="pi pi-inbox"
                                    class="p-button-primary p-mr-2" @click="submitMultipleGuillotine" />
                                     <Button  label="Back Step" icon="pi pi-arrow-left"
                                    class="p-button-danger p-mr-2" @click="submitMultipleBack" />
                                <!-- <Button :disabled="multipleKirimIPDS" label="Kirim IPDS" icon="pi pi-send"
                                    class="p-button-success p-mr-2" @click="submitMultipleKirimIPDS" /> -->
        ...
        <!-- <Sidebar v-model:visible="suratView" position="full">

            <div class="p-grid p-jc-center" v-if="multipleKirimIPDS == false">
                <div class="p-col-2">
                ...
                <div class="p-col-8">
                    ...
                    <br><br>
                    <ScrollPanel style="width: 793px; height: 100%" class="custom">

                        <div id="surat" ref="suratpengantar" class="text-black" style="font-size: 12px; width: 793px;">
                            ...
                            <div class="p-6 bg-white border-b border-gray-200">
                                ...
                                <p>
                                    <table style="width:300px">
                                        ...
                                        <tr>
                                            <td>Nomor</td>
                                            <td>: B-001/BPS-SULTENG/7256/06/2021</td>
                                        </tr>
                                        <tr>
                                            <td>Sifat</td>
                                            <td>: Biasa</td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                multipleGuillotine: true,
                multipleKirimIPDS: true,
            }
        },
        created() {
        ...
        watch: {
            ...
            selectedDokumens: function (newSelected, oldSelected) {
                ...
                if (newSelected.length == 0) {
                    this.multipleGuillotine = true
                    this.multipleKirimIPDS = true
                } else {
                    var r = []
                    var r2 = []
                    ...
                    if (r.includes(true)) {
                        ...
                        this.multipleGuillotine = false
                    }
                    if (r2.includes(true)) {
                        this.multipleKirimIPDS = true
                    } else {
                        this.multipleKirimIPDS = false
                    }
                    r2 = null
                    newSelected = null
                    console.log(r2, 'r2')
                    console.log(this.multipleKirimIPDS, 'multipleIPDS')
        ...
        methods: {
            ...
            async download() {
               ...
               await domtoimage.toPng(htmlDiv,
                ...
                await this.$inertia.post('/submitmultiplekirimipds', [this.selectedDokumens, this
            ...
            submitMultipleGuillotine() {
                this.$confirm.require({
                    message: 'Apakah yakin akan di guillotine semua?',
                    header: 'Multiple Guillotine Confirmation',
                    icon: 'pi pi-info-circle',
                    acceptClass: 'p-button-primary',
                    accept: () => {

                        this.$inertia.post('/submitmultipleguillotine', this.selectedDokumens, {
                            onStart: () => {
                                this.sending = true
                            },
                            onProgress: (progressEvent) => {
              ...
              submitMultipleBack() {
                this.$confirm.require({
                    ...
                    accept: () => {
                        ...
                        this.$inertia.post('/submitmultiplebackstep', this.selectedDokumens, {
                            onStart: () => {
                                this.sending = true
                            },
                            onProgress: (progressEvent) => {
            ...
            // submitMultipleKirimIPDS() {
            //     // this.suratView = true

            //     this.$confirm.require({
            //         message: 'Apakah yakin akan dikirim ke IPDS semua?',
            //         header: 'Multiple Kirim IPDS Confirmation',
            //         icon: 'pi pi-info-circle',
            //         acceptClass: 'p-button-primary',
            //         accept: () => {
            //             // this.suratView = true

            //             this.$inertia.post('/submitmultiplekirimipds', [this.selectedDokumens, this
            //                 .nosuratString, this.currentIndex
            //             ], {
            //                 onStart: () => {
            //                     this.sending = true
            ...
            //                     //     this.nosuratString = 'B-00'+this.currentIndex+'/BPS-SULTENG/7256/0'+n+'/2021';
            //                     // } 
            //                     // if (this.currentIndex.length == 2) {
            //                     //     this.nosuratString = 'B-0'+this.currentIndex+'/BPS-SULTENG/7256/0'+n+'/2021';
            //                     // } 
            //                     // if (this.currentIndex.length == 3) {
            //                     //     this.nosuratString = 'B-'+this.currentIndex+'/BPS-SULTENG/7256/0'+n+'/2021';
            //                     // } 
